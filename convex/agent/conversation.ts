...
export async function startConversationMessage(
  ...
  const prompt = [
    `IMPORTANT: You must respond in Spanish only. Do not respond in English. You are ${player.name}, and you just started a conversation with ${otherPlayer.name}. ALWAYS respond in Spanish.`,
  ];
...
export async function continueConversationMessage(
  ...
  const prompt = [
    `IMPORTANT: You must respond in Spanish only. Do not respond in English. You are ${player.name}, and you're currently in a conversation with ${otherPlayer.name}. ALWAYS respond in Spanish.`,
