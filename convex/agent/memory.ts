...
export async function rememberConversation(
  ...
  const llmMessages: LLMMessage[] = [
    {
      role: 'user',
      content: `IMPORTANT: You must respond in Spanish only. Do not respond in English. You are ${player.name}, and you just finished a conversation with ${otherPlayer.name}. ALWAYS respond in Spanish. I would
